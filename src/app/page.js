...
//                 <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-2 rounded-full bg-primary/10 text-primary text-xs md:text-sm font-medium">
//                   Since 2021
//                 </div>
...
//                   </p>
//                   <p className="text-base md:text-lg leading-relaxed text-center lg:text-left">
//                     With offices spanning India, the USA, and the UK, our global recruitment solutions combine deep local market expertise with round-the-clock support.
//                   </p>
//                   <div className="p-4 md:p-6 rounded-xl md:rounded-2xl border border-primary/30 bg-primary/10 shadow-sm">
//                     <p className="text-base md:text-lg font-semibold text-gray-900 text-center leading-relaxed">
