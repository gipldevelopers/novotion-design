...
const About = () => {
  ...
  const coreValues = [
    { 
      icon: Shield, 
      title: 'Integrity', 
      description: 'We operate our recruitment solutions with unwavering honesty, transparency, and respect. No exceptions in our hiring process. No shortcuts in talent acquisition.',
      color: 'primary'
    },
    { 
      icon: Award, 
    ...
    { 
      icon: Heart, 
      title: 'Commitment', 
      description: 'We are personally invested in your career success and hiring goals. Your talent acquisition objectives become our objectives. Your wins in recruitment are our wins.',
      color: 'primary'
    },
    { 
      icon: Lightbulb, 
      title: 'Innovation', 
      description: 'We constantly evolve our recruitment process outsourcing, adopting smarter, more human-centric hiring methods and technologies to stay ahead.',
      color: 'primary'
    },
    { 
      icon: TrendingUp, 
      title: 'Empowerment', 
      description: 'We equip professionals with the tools, career training, and confidence they need through our career support services to achieve their aspirations.',
      color: 'primary'
    },
    { 
      icon: Globe, 
  ...
  const milestones = [
    ...
    { year: '2025', title: 'Onward & Upward', description: 'Placed over 10,000+ professionals with our career support programs and continue to redefine excellence in recruitment and talent acquisition.' },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-start">
              ...
              <div className="space-y-6 animate-on-scroll">
                ...
                <div className="space-y-4 leading-relaxed text-gray-600">
                  <p className="text-sm sm:text-base">
                    But we see ourselves as something more: we are architects of opportunity and masters of talent acquisition.
                  </p>
                  <p className="text-sm sm:text-base">
                    For businesses in the UK and USA, we build high-performing teams through strategic recruitment solutions that drive sustainable growth. For skilled professionals worldwide, our career support services pave the way for long-term success.
                  </p>
                  <p className="text-sm sm:text-base">
                ...
                <div className="flex items-center gap-4 pt-4">
                  ...
                  <div className="text-sm text-gray-600">
                    <div className="font-semibold">50+ Team Members</div>
                    <div className="text-xs sm:text-sm">Across global locations</div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-slate-50/50 to-blue-50/50">
        <div className="container mx-auto px-4 sm:px-6 relative">
          <div className="text-center mb-8 sm:mb-12 animate-on-scroll">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Building Excellence 
              <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent"> Through Innovation</span>
            </h2>
          </div>
      ...
      <section id="values" className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 animate-on-scroll">
            ...
            <p className="text-gray-600 text-sm sm:text-base max-w-3xl mx-auto px-4">
              These aren't just words—they're the principles that guide every recruitment decision, every RPO partnership, and every talent placement we make.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8 sm:mb-12 animate-on-scroll">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                What Sets 
                <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent"> Novotion Apart?</span>
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              <div className="space-y-6 animate-on-scroll">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Our recruitment solutions teams are specialized across 15+ industries and countless job functions. We speak your language and understand the nuances of your workforce management needs."
                  },
                  {
                    icon: Zap,
                    title: "Complete Transparency",
                    description: "We believe in full visibility in our recruitment process outsourcing. You'll receive measurable talent acquisition outcomes, clear communication, and honest hiring updates at every step."
                  },
                  {
                    icon: Shield,
                    title: "End-to-End Partnership",
                    description: "From the first conversation about RPO services to long-term post-placement support, we are your partners for the entire recruitment journey."
                  },
                  {
                    icon: Clock,
                    title: "24/7 Support",
              ...
              <div className="relative animate-on-scroll">
                <div className="rounded-xl p-6 sm:p-8 text-white text-center shadow-xl bg-gradient-to-r from-blue-600 to-cyan-600">
                  ...
                  <div className="text-base sm:text-lg font-semibold mb-2">Placement Success Rate</div>
                  <p className="text-blue-100 text-sm sm:text-base">
                    Consistently delivering exceptional recruitment process outsourcing outcomes for both organizations and professionals through proven talent acquisition strategies.
                  </p>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 sm:mb-12 animate-on-scroll">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              ...
              <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent"> Trust Us</span>
            </h2>
            <p className="text-gray-600 text-sm sm:text-base">
              Real stories from real professionals who found their dream roles with Novotion's career support services.
            </p>
          </div>
          ...
          <div className="text-center mt-8 sm:mt-12 animate-on-scroll">
            <div className="rounded-xl p-6 sm:p-8 text-white max-w-4xl mx-auto bg-gradient-to-r from-blue-600 to-cyan-600">
              <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Ready to Experience the Novotion Difference?</h3>
              <p className="text-white text-sm sm:text-base mb-6 max-w-2xl mx-auto">
