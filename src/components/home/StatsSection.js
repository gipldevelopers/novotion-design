...
//   if (!mounted) {
//     return (
//       <section id="stats-section" className="min-h-[60vh] flex items-center bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 text-white relative overflow-hidden py-12">
//         <div className="container mx-auto px-4">
//           <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
//             {stats.map((stat, index) => (
//               <div key={index} className="text-center animate-pulse">
//                 <div className="h-16 bg-blue-500/30 rounded-lg mb-3 mx-auto w-16"></div>
//                 <div className="h-8 bg-blue-500/30 rounded mb-2"></div>
...
//         <div className="absolute top-10 right-10 w-40 h-40 bg-cyan-400/10 rounded-full mix-blend-soft-light filter blur-2xl animate-pulse"></div>
//         <div className="absolute bottom-10 left-10 w-40 h-40 bg-purple-400/10 rounded-full mix-blend-soft-light filter blur-2xl animate-pulse delay-1000"></div>
//       </div>
...
//                 <div className="relative bg-white/10 backdrop-blur-sm rounded-xl p-3 group-hover:bg-white/20 transition-all duration-300">
//                   <stat.icon className="h-6 w-6 text-cyan-300" />
//                 </div>
//               </div>
//               <div className="text-2xl md:text-3xl font-bold mb-2 bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent">
//                 {counted ? stat.value : '0'}
//               </div>
//               <div className="text-blue-200 font-medium text-sm mb-2">{stat.label}</div>
//               <div className="text-blue-300/80 text-xs">{stat.description}</div>
//             </div>
//           ))}
//         </div>
...
//               {[1, 2, 3].map((item) => (
//                 <div key={item} className="w-6 h-6 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full border-2 border-white flex items-center justify-center text-xs font-bold text-white">
//                   {item}
//                 </div>
//               ))}
//             </div>
//             <span className="text-blue-200 text-sm font-medium">Trusted by 500+ companies worldwide</span>
//           </div>
//         </div>
//       </div>
